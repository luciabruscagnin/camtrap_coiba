...
agoutigross <- read.csv("agouti_output/coiba-national-park-tool-use-20230110132125/observations.csv", header = TRUE)

# open the associated deployment keys (also downloaded from agouti.eu)
depl_keys <- read.csv("agouti_output/coiba-national-park-tool-use-20230110132125/deployments.csv", header = TRUE)
...
multimedia <- read.csv("agouti_output/coiba-national-park-tool-use-20230110132125/media.csv", header = TRUE)
