...
agoutigross <- read.csv("agouti_output/coiba-national-park-tool-use-20220317114932/observations.csv", header = TRUE)

# open the associated deployment keys (also downloaded from agouti.eu)
depl_keys <- read.csv("agouti_output/coiba-national-park-tool-use-20220317114932/deployments.csv", header = TRUE)
...
multimedia <- read.csv("agouti_output/coiba-national-park-tool-use-20220317114932/media.csv", header = TRUE)
