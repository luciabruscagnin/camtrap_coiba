...
agoutigross <- read.csv("agouti_output/coiba-national-park-tool-use-20230518123336/observations.csv", header = TRUE)

# open the associated deployment keys (also downloaded from agouti.eu)
depl_keys <- read.csv("agouti_output/coiba-national-park-tool-use-20230518123336/deployments.csv", header = TRUE)
...
multimedia <- read.csv("agouti_output/coiba-national-park-tool-use-20230518123336/media.csv", header = TRUE)
